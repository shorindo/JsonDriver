/*
 * Copyright (C) 2014-2015 Shorindo, Inc.
 *      http://shorindo.com
 *
...
(function() {
    ...
    var COMMANDS = {										
        ...
        '/session/:sessionId/execute_async'                 : doExecuteAsync,
    ...
    function doExecute(rpc) {
        try {
            ...
            for (var i = 0; i < rpc.data.args.length; i++) {
                if (rpc.data.args[i] === null) {
                    continue;
                } else if (typeof(rpc.data.args[i]) == 'object') {
